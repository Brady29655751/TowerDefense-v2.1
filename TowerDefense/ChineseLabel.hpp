#ifndef CHINESELABEL_HPP
#define CHINESELABEL_HPP
...
namespace Engine {
	...
	/// </summary>
	class ChineseLabel : public IObject {
	protected:
		// Smart pointer to font.
		std::shared_ptr<ALLEGRO_FONT> font;
	public:
		// Text to draw.
		ALLEGRO_USTR* Chinese_Text;
		// Text's color.
		ALLEGRO_COLOR Color;
		/// <summary>
		/// Construct a chinese label object. Remember to add an 'L'!
		/// </summary>
		...
		explicit ChineseLabel(const wchar_t* text, const std::string& font, int fontSize, float x, float y, unsigned char r = 0, unsigned char g = 0, unsigned char b = 0, unsigned char a = 255, float anchorX = 0, float anchorY = 0);
		/// <summary>
